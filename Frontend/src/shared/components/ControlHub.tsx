    ...
    <>
      ...
      <div className="fixed top-8 right-8 sm:right-12 lg:right-16 z-50 flex flex-col items-end select-none">
        ...
        <div className="flex items-center space-x-2 bg-[#f4f6f8]/70 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/50 shadow-[0_4px_24px_rgba(0,0,0,0.03)] transition-colors duration-500">
          ...
          <span
            className="h-4 w-[1px] bg-slate-300/60 block"
            aria-hidden="true"
          />
          ...
          >
            <div className="w-4 h-3 flex flex-col justify-between items-end">
              <span
                className={`w-4 h-[1.25px] bg-current transition-all duration-300 transform origin-right ${isMenuOpen ? "-rotate-45 -translate-x-[1px]" : ""}`}
              />
              <span
                className={`w-2.5 h-[1.25px] bg-current transition-all duration-300 ${isMenuOpen ? "opacity-0 scale-x-0" : ""}`}
              />
              <span
                className={`w-3.5 h-[1.25px] bg-current transition-all duration-300 transform origin-right ${isMenuOpen ? "rotate-45 -translate-x-[1px] w-4" : ""}`}
              />
            </div>
          </button>
        </div>
            ...
            <>
              <div className="space-y-2">
                ...
                <p className="text-xs font-normal text-slate-600 leading-relaxed tracking-wide">
                  This vault layer is currently locked. Pass authentication
                  parameters to map your archives.
                </p>
              </div>
      ...
      >
        ...
        >
          ...
          <div className="flex items-center border-b border-slate-300/40 px-5 py-4">
            <span className="text-xl text-slate-400 font-serif mr-4 select-none transform -translate-y-[1px]">
              ⌕
            </span>
            <input
              ref={searchInputRef}
