                              ...
                              <div className="flex justify-between items-start mb-5 relative">
                                ...
                                <div className="relative">
                                  <button
                                    ...
                                    className={`
                                      relative p-1.5 rounded-lg cursor-pointer
                                      /* Smooth transitions for hover, scale, and background */
                                      transition-all duration-200 ease-out
                                      
                                      /* Base styles */
                                      bg-white/50 text-neutral-700 shadow-xs backdrop-blur-xs
                                      
                                      /* Hover state: lifts up slightly, brightens background, deepens shadow */
                                      hover:bg-white/90 hover:text-neutral-900 hover:shadow-md
                                      
                                      /* Active/Click state: tactile press down */
                                      active:translate-y-0 active:scale-95 active:bg-white/100 active:shadow-xs
                                      
                                      /* Rotation based on menu open state with smooth transition */
                                      ${isMenuOpen ? "rotate-180 bg-white/90 text-neutral-900" : "rotate-90"}
                                    `}
                                  >
